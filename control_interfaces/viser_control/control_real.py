...
def main(
    ...
    def start_egm_control():
        ...
        print(se_result)
        # while not EGMActive:
        #     # print("Waiting for EGM to be active")
        #     time.sleep(0.01)
        time.sleep(0.1)
    ...
    while True:
        ...
        # if len(urdf_vis_real._urdf._cfg) != 0:
        #     # import pdb; pdb.set_trace()
        #     pos_error = jnp.array(joints[0:14]-ja_array)[0:14]
        #     # print(pos_error)
        #     if not jnp.all(pos_error[0:14] == 0):
        #         jv_msg = Float64MultiArray()
        #         jv_msg.data = -1000000*pos_error 
        #         # print(jv_msg.data)
